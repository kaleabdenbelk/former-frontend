      ...
      <div className="space-y-5">
        ...
        <div className="space-y-2">
          <div className="flex items-center justify-between">
            ...
            <Button size="sm" variant="outline" onClick={() => onFieldsChange([...fields, newField()])}>
          ...
          {fields.length === 0 ? (
            <EmptyState
              ...
              action={
                <Button size="sm" onClick={() => onFieldsChange([...fields, newField()])}>
                  <Plus className="size-4" /> Add field
                </Button>
              }
            />
            ...
            <div className="space-y-2">
              {fields.map((field, index) => (
                <FieldEditorRow
                  ...
                  onDuplicate={() => {
                    const copy: Field = { ...field, id: newField().id, label: `${field.label} copy` };
                    const next = [...fields];
